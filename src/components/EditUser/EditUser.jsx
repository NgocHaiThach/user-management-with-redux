        ...
        <Container>
            <Row>
                <form className="mt-20">
                    ...
                    {errors?.name?.type === "required" && <p className="valid-form__message">* Trường này bắt buộc, vui lòng nhập</p>}
                    ...
                    {errors?.phone?.type === "required" && <p className="valid-form__message">* Trường này bắt buộc, vui lòng nhập</p>}
                    ...
                    {errors?.email?.type === "required" && <p className="valid-form__message">* Trường này bắt buộc, vui lòng nhập</p>}
                    ...
                    {errors?.role?.type === "required" && <p className="valid-form__message">* Trường này bắt buộc, vui lòng nhập</p>}
                </form>
            </Row>
            <Button
                variant="secondary"
